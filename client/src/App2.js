...
import Sample from './components2/InputForm2.jsx'
import LoginPage from './pages2/LoginPage.jsx';
import LogoutFunction from './pages2/LogoutFunction.jsx';
import SignUpPage2 from './pages2/SignUpPage.jsx';
import DashboardPage from './pages2/DashboardPage2.jsx';
import Auth from './utils2/Auth';
import API from './utils2/API';
    ...
    render() {
        ...
        return (
            ...
            <Router>
                <div className='grid'>
                    <nav>
                        <Menu fixed='top' inverted style={{ backgroundColor: '#2b2c2d' }}  >
